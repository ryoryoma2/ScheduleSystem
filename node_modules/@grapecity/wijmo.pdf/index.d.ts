...
import { Color, EventArgs, Point, Event, Size } from '@grapecity/wijmo';
import * as pdfSecurity from '@grapecity/wijmo.pdf.security';
import * as selfModule from '@grapecity/wijmo.pdf';
export declare var __c1pdfkitIsModule: any;
export declare function softPdfSecurity(): typeof pdfSecurity;
...
*/
export declare enum PdfPrintPermission {
    /**
...
*/
export declare enum PdfVersion {
    /**
    * PDF version 1.3.
    */
    v1_3 = 0,
...
export interface IPdfDocumentOptions {
    ...
    */
    pageAdded?: (sender: PdfDocument, args: EventArgs) => void;
}
