 ...
 * Implements the {@link wijmo.grid.immutable.ImmutabilityProvider} class and
 * its accompanying stuff.
 * It allows you to use {@link wijmo.grid.FlexGrid} control with immutable data sources,
...
import { CollectionView, Event, EventArgs } from '@grapecity/wijmo';
import { FlexGrid } from '@grapecity/wijmo.grid';
import * as selfModule from '@grapecity/wijmo.grid.immutable';
/**
 * Provides data for the {@link ImmutabilityProvider.dataChanged} event.
 */
export declare class DataChangeEventArgs extends EventArgs {
    /**
 ...
 * event to fire.
 */
export declare enum DataChangeAction {
 ...
 */
export declare class CloningItemEventArgs extends EventArgs {
 ...
 * ```
 */
export declare class ImmutabilityProvider {
 ...
 */
export declare function copyObject(target: any, ...src: any[]): any;
