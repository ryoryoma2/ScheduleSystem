 ...
 * Defines the {@link Sunburst} and {@link TreeMap} chart controls and their associated classes.
 */
/**
 *
 */
export declare var ___keepComment: any;
import { Rect, Point, Size } from '@grapecity/wijmo';
import { FlexPie, HitTestInfo, SelectionMode, FlexChartBase, IRenderEngine, DataLabel, ChartTooltip } from '@grapecity/wijmo.chart';
 ...
 */
export declare class TreeMap extends FlexChartBase {
 ...
 */
export declare class Sunburst extends FlexPie {
    private _bindName;
    private _processedData;
    ...
    _renderPie(engine: IRenderEngine, i: number, radius: number, innerRadius: number, startAngle: number, offset: number): void;
