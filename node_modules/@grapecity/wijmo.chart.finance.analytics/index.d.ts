 ...
 * Analytics extensions for {@link FinancialChart}.
 */
/**
 *
 */
...
import { SeriesBase, _HitTester, ChartType, _DataPoint, Axis, IRenderEngine, RenderEventArgs, LabelPosition, DataPoint } from '@grapecity/wijmo.chart';
/**
 * Represents a Fibonacci Retracements tool for the {@link FinancialChart}.
    ...
    * </pre>
    */
export declare class Fibonacci extends SeriesBase {
    private _high;
    private _low;
    private _minX;
    private _maxX;
 ...
 */
export declare class FibonacciArcs extends SeriesBase {
    private _start;
    private _end;
    private _levels;
    private _labelPosition;
 ...
 */
export declare class FibonacciFans extends SeriesBase {
    private _start;
    private _end;
    private _levels;
    private _labelPosition;
 ...
 */
export declare class FibonacciTimeZones extends SeriesBase {
    private _startX;
    private _endX;
    private _levels;
    private _labelPosition;
 ...
 */
export declare class OverlayIndicatorBase extends SeriesBase {
    private __hitTester;
    _styles: any;
    _seriesCount: number;
    /**
