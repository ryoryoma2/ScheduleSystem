 ...
 * Extension that includes the {@link FlexGridSearch} control, which provides
 * full-text search/filter/highlight services for {@link FlexGrid} controls.
 */
/**
 *
 */
 ...
 * ```
 */
export declare class FlexGridSearch extends Control {
