 ...
 */
export declare function getTypes(arr: any[]): IBindingInfo[];
/**
 ...
 */
export declare function setSelectionRange(e: any, start: number, end?: number): boolean;
/**
 ...
 * ```
 */
export declare function saveFile(content: string, fileName: string, type?: string): void;
/**
