...
import { Size, CancelEventArgs, ObservableArray, DataType, Point, Rect, CollectionViewGroup, NotifyCollectionChangedEventArgs, Aggregate, Event, EventArgs, ICollectionView, Control, Tooltip, Binding, IEditableCollectionView, IBindingInfo } from '@grapecity/wijmo';
 ...
 * ```
 */
export declare class DataMap<K = any, V = any> {
    _cv: ICollectionView;
    _keyPath: string;
    _displayPath: string;
    _sortByVal: boolean;
...
export declare class RowCol {
     ...
     * **wijmo.input module** to be loaded.
     */
    dataMap: DataMap;
    /**
     ...
     * The drop-down list is enabled only if the **wijmo.input** module to be
     * loaded.
     */
...
export declare class Column extends RowCol {
     ...
     * col.cellTemplate = (ctx: ICellTemplateContext) => glbz`${value}:${col.format}';
     *
 ...
 */
export declare class RowColCollection<T extends RowCol = RowCol> extends ObservableArray<T> {
    _g: FlexGrid;
    _frozen: number;
    _lastFrozen: number;
 ...
 */
export declare class ColumnCollection extends RowColCollection<Column> {
    _descById: string;
    /**
 ...
 */
export declare class RowCollection extends RowColCollection<Row> {
    _maxLevel: number;
    _ariaLabel: string;
    /**
 ...
 */
export declare enum AllowSorting {
    /**
 ...
 */
export declare enum AllowPinning {
 ...
 */
export declare enum ClipStringOptions {
 ...
 */
export declare class FlexGrid extends Control {
 ...
 */
export declare class _ColumnGroupHandler {
