...
/**
 * {@module wijmo.cloud}
 * Provides classes that support Google Cloud products, including
 * Google Sheets, Firebase, and GAPI (OAuth2).
 *
 * The {@link OAuth2} class uses the
 * <a href="https://github.com/google/google-api-javascript-client" target="_blank">Google API Client Library</a>,
 * which is automatically loaded at run-time from this url:
...
import { ObservableArray, Event, EventArgs, CollectionView, DataType, SortDescription, CancelEventArgs, RequestErrorEventArgs, PageChangingEventArgs } from '@grapecity/wijmo';
import { FlexGridFilter, ConditionFilter, FilterCondition, ValueFilter, Operator } from '@grapecity/wijmo.grid.filter';
import * as wjcGridFilter from '@grapecity/wijmo.grid.filter';
import * as selfModule from '@grapecity/wijmo.cloud';
/**
...
export declare class OAuth2 {
     ...
     */
    onUserChanged(e?: EventArgs): void;
    /**
 ...
 */
export declare class OAuthError extends EventArgs {
    _error: any;
    /**
 ...
 */
export declare class Snapshot extends CollectionView {
    _collection: any;
    _query: any;
    _toGetData: any;
    _loading: boolean;
     ...
     */
    onLoading(e: CancelEventArgs): boolean;
    /**
 ...
 */
export declare class FirestoreErrorEventArgs extends CancelEventArgs {
    _error: any;
    /**
 ...
 * ```
 */
export declare class Sheet extends CollectionView {
    _gSheet: GoogleSheet;
    _id: number;
    _title: string;
    _loading: boolean;
...
export declare class GoogleSheet {
     ...
     */
    readonly sheets: ObservableArray<Sheet>;
    /**
     ...
     */
    onAccessTokenChanged(e?: EventArgs): void;
...
export declare class Firestore {
    _projectId: string;
    _collections: ObservableArray<Collection>;
    _accessToken: string;
    _idToken: string;
    _fbToken: string;
    _apiKey: string;
     ...
     */
    readonly collections: ObservableArray<Collection>;
    /**
 ...
 * client libraries.
 */
export declare class Collection extends CollectionView {
    _store: Firestore;
    _name: string;
    _loading: boolean;
    _toGetData: any;
    ...
    _deferCommits: boolean;
    _hasPendingChanges: boolean;
    _filterProvider: FlexGridFilter;
    _totalCount: number;
    _orderBy: SortDescription[];
    _fieldFilters: any[];
    _limit: number;
     ...
     * const customers = new Collection(fsNWind, 'Customers', {
    ...
    _getQueryConditionFilter(filters: any[], cf: ConditionFilter): void;
    _getQuerySimpleFilter(fc: FilterCondition, path: string): any;
    _getFilterOperator(op: Operator): string;
    _getQueryValueFilter(filters: any[], vf: ValueFilter): void;
}
export {};
