...
import { PdfBrush, PdfPageArea, IPdfFontFile, IPdfDocumentOptions } from '@grapecity/wijmo.pdf';
...
export declare class PdfFormatItemEventArgs extends /*wijmo.grid.CellRangeEventArgs*/ CancelEventArgs {
    ...
    */
     ...
     */
    drawBackground(brushOrColor?: PdfBrush | Color | string): void;
    /**
...
export declare class _CellRenderer {
    ...
    private _area;
    private _borderWidth;
    static _drawBackground(area: pdf.PdfPageArea, clientRect: Rect, brushOrColor: pdf.PdfBrush | Color | string): void;
...
declare class FlexGridAdapter<G extends grid.FlexGrid> implements _IFlexGridAdapter {
    private _flex;
    private _settings;
    private _styleCache;
    ...
    readonly columns: grid.ColumnCollection;
    readonly rows: grid.RowCollection;
...
export declare class _TransposedGridAdapter extends FlexGridAdapter<transposed.TransposedGrid> {
    static getBindingColumn(panel: grid.GridPanel, row: number): grid.Column;
    getColumn(panel: grid.GridPanel, row: number, col: number): _IColumn;
}
/**
