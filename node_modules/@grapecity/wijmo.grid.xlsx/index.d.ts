...
import { FlexGrid, GridPanel, Column, CellRange, CellRangeEventArgs } from '@grapecity/wijmo.grid';
import * as mDetail from '@grapecity/wijmo.grid.detail';
import * as mMultiRow from '@grapecity/wijmo.grid.multirow';
import * as mTransposed from '@grapecity/wijmo.grid.transposed';
import * as mTransposedMultiRow from '@grapecity/wijmo.grid.transposedmultirow';
...
export declare function softTransposed(): typeof mTransposed;
export declare function softTransposedMultiRow(): typeof mTransposedMultiRow;
/**
...
export declare class FlexGridXlsxConverter {
     ...
     *  );</pre>
     */
    static saveAsync(grid: FlexGrid, options?: IFlexGridXlsxOptions, fileName?: string, onSaved?: (base64: string, workbook: mXlsx.Workbook) => any, onError?: (reason?: any) => any, onProgress?: (value: number) => void, asyncWorkbook?: boolean): mXlsx.Workbook;
    /**
    ...
    static _getCellStyle(panel: GridPanel, fakeCell: HTMLDivElement, r: number, c: number, styleCache: _StyleCache | null, forceUpdateContent: boolean): CSSStyleDeclaration;
...
export declare class XlsxFormatItemEventArgs extends CellRangeEventArgs {
    ...
    private _cellsCache;
    private _styleCache;
    constructor(panel: GridPanel, rng: CellRange, cell: HTMLDivElement, patternCell: HTMLDivElement, cellsCache: _CellsCache, styleCache: _StyleCache, xlsxCell: mXlsx.IWorkbookCell);
    /**
...
export declare class _StyleCache {
    private _cache;
    private _max;
    private _size;
