 ...
 * Defines the {@link AnnotationLayer} and various annotations for {@link FlexChart} and
 * {@link FinancialChart}.
 */
/**
 *
...
import { Size, Point, ObservableArray } from '@grapecity/wijmo';
import { DataPoint, IRenderEngine, Axis, FlexChartCore } from '@grapecity/wijmo.chart';
/**
...
export declare class Polygon extends Shape {
     ...
     */
    readonly points: ObservableArray;
    _resetDefaultValue(): void;
    _getCSSClass(): string;
    _getContentCenter(): DataPoint;
    _renderShape(engine: IRenderEngine): void;
...
export declare class AnnotationLayer {
     ...
     */
    readonly items: ObservableArray;
    /**
